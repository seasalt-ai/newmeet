...
```js
findStill({ app: 'google-meet', key: 'recording', locale: 'es' })
```
...
- `product/recording.png` — Una grabación en curso en el panel lateral: tiempo transcurrido, transcripción en vivo y un espacio para notas · 424×988
- `product/side-panel-empty.png` — El panel lateral antes de grabar, con las opciones de audio y pantalla y el botón de grabar · 424×988
