...
```js
findStill({ app: 'google-meet', key: 'recording', locale: 'vi' })
```
...
- `product/recording.png` — Đang ghi trong bảng bên: thời gian đã trôi, bản ghi lời trực tiếp và chỗ để ghi chú · 424×988
- `product/side-panel-empty.png` — Bảng bên trước khi ghi, với các tuỳ chọn âm thanh và màn hình cùng nút ghi · 424×988
