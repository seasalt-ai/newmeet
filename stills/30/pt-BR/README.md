...
```js
findStill({ video: '30', key: 'brand-hero', locale: 'pt-BR' })
```
...
- `product/brand-hero.png` — O SeaMeet em todas as telas: a mesma gravação no app de computador, num celular e no navegador · 1920×1080
