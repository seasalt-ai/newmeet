...
```js
findStill({ video: '30', key: 'brand-hero', locale: 'ru' })
```
...
- `product/brand-hero.png` — SeaMeet на всех устройствах: одна и та же запись в приложении, на телефоне и в браузере · 1920×1080
