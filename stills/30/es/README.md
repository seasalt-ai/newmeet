...
```js
findStill({ video: '30', key: 'brand-hero', locale: 'es' })
```
...
- `product/brand-hero.png` — SeaMeet en todas las superficies: la misma grabación en la app de escritorio, un móvil y el navegador · 1920×1080
