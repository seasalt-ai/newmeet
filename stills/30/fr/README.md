...
```js
findStill({ video: '30', key: 'brand-hero', locale: 'fr' })
```
...
- `product/brand-hero.png` — SeaMeet sur tous les supports : le même enregistrement sur l'application de bureau, un téléphone et le navigateur · 1920×1080
