...
```js
findStill({ video: '30', key: 'brand-hero', locale: 'en' })
```
...
- `product/brand-hero.png` — SeaMeet across surfaces — the same recording on the desktop app, a phone and the browser · 1920×1080
