...
```js
findStill({ video: '32', key: 'post-stop-share', locale: 'fr' })
```
...
- `product/post-stop-share.png` — Juste après l’arrêt : SeaMeet ouvre lui-même la fenêtre de partage, l’enregistrement déjà sauvegardé · 1920×1080
- `product/share-dialog.png` — La fenêtre de partage : personnes ajoutées par e-mail, lien ouvert à quiconque le possède, et la mention qu’il faut se connecter pour voir · 1920×1080
