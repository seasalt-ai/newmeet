...
```js
findStill({ video: '32', key: 'post-stop-share', locale: 'ja' })
```
...
- `product/post-stop-share.png` — 録音を止めた直後：SeaMeet が共有ダイアログを自分で開き、録音はすでに保存済み · 1920×1080
- `product/share-dialog.png` — 共有ダイアログ：メールで追加したユーザー、リンクを知っている全員に開いたアクセス権、そして閲覧にはサインインが必要という注記 · 1920×1080
