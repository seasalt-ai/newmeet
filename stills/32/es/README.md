...
```js
findStill({ video: '32', key: 'post-stop-share', locale: 'es' })
```
...
- `product/post-stop-share.png` — Justo después de parar: SeaMeet abre el diálogo de compartir por sí solo, con la grabación ya guardada · 1920×1080
- `product/share-dialog.png` — El diálogo de compartir: personas añadidas por email, el enlace abierto a cualquiera que lo tenga, y el aviso de que hay que iniciar sesión para ver · 1920×1080
