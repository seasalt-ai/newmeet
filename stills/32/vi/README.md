...
```js
findStill({ video: '32', key: 'post-stop-share', locale: 'vi' })
```
...
- `product/post-stop-share.png` — Ngay sau khi dừng: SeaMeet tự mở hộp chia sẻ, bản ghi đã được lưu · 1920×1080
- `product/share-dialog.png` — Hộp chia sẻ: người được thêm bằng email, quyền liên kết mở cho bất kỳ ai có nó, và ghi chú rằng phải đăng nhập mới xem được · 1920×1080
