...
```js
findStill({ video: '32', key: 'post-stop-share', locale: 'pt-BR' })
```
...
- `product/post-stop-share.png` — Logo após parar: o SeaMeet abre sozinho a caixa de compartilhamento, com a gravação já salva · 1920×1080
- `product/share-dialog.png` — A caixa de compartilhamento: pessoas adicionadas por e-mail, link liberado para quem tiver o endereço, e o aviso de que é preciso login para ver · 1920×1080
