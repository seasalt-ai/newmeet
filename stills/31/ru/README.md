...
```js
findStill({ video: '31', key: 'live-transcription', locale: 'ru' })
```
...
- `product/live-transcription.png` — Расшифровка в реальном времени во время записи: полоса CC под панелью записи и текст, заполняющийся по ходу разговора · 1600×900
- `product/recording-modes.png` — Выбор того, что записывать: только звук, весь экран, одно окно или область · 1600×900
