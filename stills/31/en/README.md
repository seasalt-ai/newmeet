...
```js
findStill({ video: '31', key: 'live-transcription', locale: 'en' })
```
...
- `product/live-transcription.png` — Live transcription while recording: the CC strip under the recording pill, and the transcript filling in as people speak · 1600×900
- `product/recording-modes.png` — Choosing what to record: audio only, the whole screen, one window, or a region · 1600×900
