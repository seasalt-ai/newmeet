...
```js
findStill({ video: '31', key: 'live-transcription', locale: 'es' })
```
...
- `product/live-transcription.png` — Transcripción en vivo mientras grabas: la franja CC bajo la píldora de grabación y la transcripción llenándose a medida que se habla · 1600×900
- `product/recording-modes.png` — Elegir qué grabar: solo audio, toda la pantalla, una ventana o una región · 1600×900
