...
```js
findStill({ app: 'wechat', key: 'wechat-ai-summary', locale: 'en' })
```
...
- `product/wechat-ai-summary.png` — Summary, decisions and action items in your own language (cropped to the app window) · 1712×928
- `product/wechat-memory.png` — Meeting Memory — people, organizations, topics (cropped to the app window) · 1712×928
- `product/wechat-mixed-transcript.png` — One transcript carrying both 中文 and English, timestamped (cropped to the app window) · 1712×928
- `product/wechat-seek.png` — A transcript timestamp seeks the player (cropped to the app window) · 1712×928
...
- `demo/wechat-call-running.png` — A WeChat call already in progress, with nothing recording it · 1920×1080
- `demo/wechat-prompt.png` — SeaMeet asks the moment the call starts · 1920×1080
- `demo/wechat-recording.png` — Recording both sides of the call, no screen share · 1920×1080
