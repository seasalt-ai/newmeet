...
```js
findStill({ app: 'wechat', key: 'wechat-ai-summary', locale: 'ja' })
```
...
- `product/wechat-ai-summary.png` — あなたの言語で書かれた要約・決定事項・アクションアイテム (cropped to the app window) · 1712×928
- `product/wechat-memory.png` — ミーティングメモリー — 人物、組織、トピック (cropped to the app window) · 1712×928
- `product/wechat-mixed-transcript.png` — 中国語と英語が一つの文字起こしに、タイムスタンプつきで (cropped to the app window) · 1712×928
- `product/wechat-seek.png` — 文字起こしのタイムスタンプで再生位置が移動する (cropped to the app window) · 1712×928
...
- `demo/wechat-call-running.png` — すでに進行中の WeChat 通話。まだ何も録音していない · 1920×1080
- `demo/wechat-prompt.png` — 通話が始まった瞬間に SeaMeet が確認する · 1920×1080
- `demo/wechat-recording.png` — 通話の双方を録音、画面共有なし · 1920×1080
